...
export const Header = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col bg-[url('assets/img/Header-image.png')] w-full bg-cover mb-[13px] xl:bg-[url('assets/img/Header-desktop.png')] relative">
