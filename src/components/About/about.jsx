export const About = () => {
  return (
    <div
      id="about"
      className="bg-[url('assets/img/Tower.png')] bg-cover bg-no-repeat w-full h-[717px] flex flex-col justify-end mb-[49px] xl:bg-[url('assets/img/tower-desktop.png')]"
    >
      <div className="w-full h-[499px] flex flex-col items-center bg-[url('assets/img/spot.png')] bg-cover bg-no-repeat xl:h-full xl:w-full xl:bg-contain xl:justify-end">
